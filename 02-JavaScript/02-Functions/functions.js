...
function SwitchBackground()
{
    ...
    //switchButton.attributes.src.nodeValue = switchButton.attributes.src.nodeValye == 'img/moon.png' ? 'img/sun.png' : 'img/moon.png';
...
function tickCountdown()
{
    ...
    //Приодим дату в целевом времени к выбранной дате
...
function createTimeBlock(name, value)
{
    ...
    unit.innerHTML = addLeadingZer(value);
