...
namespace ContosoUniversity.Migrations
{
    ...
    [Migration("20251011155947_mssql.local_migration_172")]
    partial class mssqllocal_migration_172
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Department", b =>
                {
                    b.HasOne("ContosoUniversity.Models.Instructor", "Administtrator")
                        .WithMany()
                        .HasForeignKey("InstructorID");

                    b.Navigation("Administtrator");
                });
